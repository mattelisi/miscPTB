function[texture , sdTilt, meanTilt] = makeNoisyLinesTex(win, visual, mu, sigma ,n ,lineLength, lineWidth, textureWidth, color)
% 
...
radii = floor((textureWidth/2) .* rand(n,1));
rho = (2*pi) .* rand(n,1);
...
Screen('DrawLines', texture, XYcoord, lineWidth, color, [textureWidth/2, textureWidth/2], 1);
